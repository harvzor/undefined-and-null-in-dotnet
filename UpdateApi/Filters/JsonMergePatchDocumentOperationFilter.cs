...
namespace UpdateApi.Filters;

/// <summary>
/// https://github.com/Morcatko/Morcatko.AspNetCore.JsonMergePatch/blob/master/src/6.0-testApp/JsonMergePatchDocumentOperationFilter.cs
/// </summary>
	...
	public void Apply(OpenApiOperation operation, OperationFilterContext context)
	{
		...
		void CleanUpSchemas(string jsonMergePatchSchemaId)
		{
			...
			if (schemas.TryGetValue(jsonMergePatchSchemaId, out var jsonMergePatchSchema))
			{
				...
				// Not sure why but this line fails:
